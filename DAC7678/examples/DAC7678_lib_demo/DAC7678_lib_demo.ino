...
void setup()
{
  ...
  dac.enable(PIN_A, OFF);             // Power down Channel A
  ...
  dac.enable(PIN_A, ON);              // Power up DAC Channel F
  delay(5000);                        // wait a little
}
...
void loop()
{
  ...
  dac.enable(OFF);                 // Power down all DAC channels 
  delay(5000);                        // Wait 5 seconds

  dac.enable(ON);                  // Power up all DAC Channels
